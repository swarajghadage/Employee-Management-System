...
<div class="all">
<div id="box">
    <div class="btn-custom"><a href="ViewDepartmentEmp.jsp"><i class="fa fa-home"></i>&nbsp;Home</a></div>
    <button class="btn-custom" onclick="printTable()"><i class="fa fa-print"></i>&nbsp;Print</button>
      <div class="btn-custom"><a href="ViewDepartmentEmp.jsp"><i class="fa fa-arrow-circle-left"></i>&nbsp;Back</a></div>
</div>

...
<div id="box5">
    ...
    <div class="btn-custom"><a href="viewatd"><i class="fa fa-user"></i>&nbsp;Viewatd </a></div>
   
     
     <button class="btn-custom" onclick="printTable()">Print</button>
      <div class="btn-custom"><a href="home2.jsp"><i class="fa fa-arrow-circle-left"></i>&nbsp;Back</a></div>
</div>

    <div id="box">
        <h1 id="head"><u> Attedence Details</u></h1>
        <center>
            <h1  class="h1"  >${message}</h1>
            <h1 class="h2" >${errormessage}</h1>
        </center>
        <form action="atd" method="post" name="employeeForm" onsubmit="return validateForm()">
            <div id="box1">

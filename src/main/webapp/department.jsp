...
<div id="box5">
    ...
    <div class="btn-custom"><a href="ViewAllDept"><i class="fa fa-user"></i>&nbsp;Viewall </a></div>
    <div class="btn-custom"><a href="updateDt"><i class="fa fa-user"></i>&nbsp;Update </a></div>
    <div class="btn-custom"><a href="deletedept"><i class="fa fa-user"></i>&nbsp;Remove </a></div>
    ...
    <div id="box">
        <h1 id="head"><u>New Department Details</u></h1>
        <center>
            <h1  class="h1"  >${message}</h1>
            <h1 class="h2" >${errormessage}</h1>
        </center>
        <form action="dept" method="post" name="employeeForm" onsubmit="return validateForm()">
            <div id="box1">

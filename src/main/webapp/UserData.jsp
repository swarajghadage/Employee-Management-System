...
<div id="box">
    ...
    <div class="btn-custom"><a href="addreport.jsp"><i class="fa fa-user"></i>&nbsp;Add Report</a></div>
    <div class="btn-custom"><a href="ViewSal"><i class="fa fa-user"></i>&nbsp;View Salary Dtls </a></div>
      <div class="btn-custom"><a href="Viewall"><i class="fa fa-user"></i>&nbsp;ViewAllEmp </a></div>
       <div class="btn-custom"><a href="Attedence.jsp"><i class="fa fa-user"></i>&nbsp;Attendance </a></div>

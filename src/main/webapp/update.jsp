    ...
    <tbody>
      <c:forEach items="${emplist}" var="e">
        <tr>
          ...
          <td>${e.designation}</td>
          <td>${e.aadhar}</td>
          <td> <a href="update1.jsp?id=${e.id}&name=${e.name}&dob=${e.dob}&sal=${e.sal}&address=${e.address}&phone=${e.phone}&email=${e.email}&education=${e.education}&designation=${e.designation}&aadhar=${e.aadhar}">

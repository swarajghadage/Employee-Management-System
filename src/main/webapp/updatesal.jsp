...
<div id="box">
    ...
    <div class="btn-custom"><a href="ViewSal"><i class="fa fa-user"></i>&nbsp;Viewall salary </a></div>
    <div class="btn-custom"><a href="updateDt"><i class="fa fa-user"></i>&nbsp;Update salary </a></div>
    ...
    <tbody>
      <c:forEach items="${emplist}" var="e">
        <tr>
          ...
          <td>${e.ptax}</td>
          <td>${e.bonus}</td>
          <td>${e.providentFund}</td>
          <td>${e.netSalary}</td>
          
        
          <td> <a href="updatesal1.jsp?id=${e.id}&name=${e.name}&dept=${e.dept}&medical=${e.medical}&ptax=${e.ptax}&bonus=${e.bonus}&providentFund=${e.providentFund}&netSalary=${e.netSalary}">

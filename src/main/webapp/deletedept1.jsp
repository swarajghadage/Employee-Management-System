...
<body>
    ...
    <form action="deletedept1" method="post" class="center"> 
        <input type="hidden" name="id" style="height: 30px;" value="<%= request.getParameter("id") %>">
        <input type="submit" value="Delete dept" class="btn">
        <div class="btn-custom"><a href="department.jsp"><i class="fa fa-arrow-circle-left"></i>&nbsp;Back</a></div>
